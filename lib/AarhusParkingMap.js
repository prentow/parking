function ParkingMap(){
    ...
    map['Urban Level 1'] = {lat: 56.15402792829961, lng: 10.21370572644181, prettyName : 'Dokk1 Level 1'};
    map['Urban Level 2+3'] = {lat: 56.15396301219192, lng: 10.21350598245308, prettyName : 'Dokk1 Level 2&3'};
    return map;
}
