...
/**
 * Retrieves stops nearby a specific location
 *
 * @param lat The location latitude, float
 * @param lng The location longitude, float
 * @param callback function (err, result), called with (null, result) or (error) if an error occurs. Result is a simple list of stop ids.
 */
